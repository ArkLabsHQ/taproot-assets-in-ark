...
// 	createAndSetAssetInput(fundedPkt, TRANSFER_INPUT_INDEX, boardingTransfer.assetTransferOutput, assetId)

// 	// Note: This add output details
// 	tapsend.PrepareOutputAssets(context.TODO(), fundedPkt)

// 	CreateAndInsertAssetWitness(boardingTransfer.arkSpendingDetails, fundedPkt, boardingTransfer.user, server)
...
// 	_, rootKeys := CreateRoundSpendingDetails(assetId, boardingTransfer.assetBoardingAmount, user, server)
...
// 	rootTransferDetails := ArkSpendingDetails{btcControlBlock, rootKeys}
...
// 		AssetId:   assetId,
// 		ScriptKey: boardingTransfer.assetTransferOutput.ScriptKey,
// 	})
// 	if err != nil {
...
// 	_, leftKeys := CreateRoundSpendingDetails(assetId, amount/2, user, server)
// 	_, rightKeys := CreateRoundSpendingDetails(assetId, amount/2, user, server)
...
// 	leftTransferDetails := ArkSpendingDetails{leftBtcControlBlock, leftKeys}
...
// 	rightTransferDetails := ArkSpendingDetails{rightBtcControlBlock, rightKeys}
